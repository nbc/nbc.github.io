...
Si cette syntaxe fonctionne le nouveau package [duckplyr](https://duckplyr.tidyverse.org/index.html) propose une méthode beaucoup plus efficace :
...
Les deux lignes fonctionnent de la même façon que celle de `arrow` mais la conversion d'un objet duckdb en objet duckplyr est **beaucoup plus efficace**.
